...
@Slf4j
public class SchemaListViewCell extends ListCell<SchemaEntity> {

//    private final EventHandler<SchemaEditEvent> schemaEventHandler;
...
//        this.schemaEventHandler = schemaEventHandler;
